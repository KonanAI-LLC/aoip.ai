...
def simulate(
    ...
    logger.info(f"command START_VIRTUAL_MIC success {sender_instance_name}. {result}")
    ...
    logger.info(f"command WONDERSHAPER_UPLOAD_DOWNLOAD success {sender_instance_name}. {result}")
    ...
    result = CommandController.ec2_service.execute(receiver_instance_public_ip, receiver_instance_name, "alpha",
                                                   CommandGroups.START_VIRTUAL_MIC, None, non_blocking=False)
    logger.info(f"command START_VIRTUAL_MIC success {receiver_instance_name}. {result} ")
    ...
    logger.info(f"started a receiver pjsua session on receiver {receiver_instance_name} {result}")
    ...
    logger.info(f"started a sender pjsua session on receiver {sender_instance_name} {result}")
    ...
    logger.info(f"command set for killing sender pjsua session {sender_instance_name} {result}")
    ...
    result = CommandController.ec2_service.execute(receiver_instance_public_ip, receiver_instance_name, "alpha", None,
                                                   Command.KILL_PJSUA, non_blocking=False)
    logger.info(f"command set for killing receiver pjsua session {receiver_instance_name} {result}")
    ...
    result = CommandController.ec2_service.execute(receiver_instance_public_ip, receiver_instance_name, "alpha", None,
                                                   ...
                                                   non_blocking=False)
    logger.info(f"fmmpeg process output {result}")
    ...
    logger.info(f"command WONDERSHAPER_UPLOAD_DOWNLOAD success {receiver_instance_name}. {result}")
    ...
    logger.info(f"uploaded wav file to {s3_bucket_url} {result}")
